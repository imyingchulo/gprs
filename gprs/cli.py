...
@click.command()
@click.option('--dir_output', metavar='<str>', help='dir to GWAS summary file')
@click.option('--inputfile', metavar='<str>', help='full path to GWAS summary file')
@click.option('--output_file_name', metavar='<str>', help='updtae GWAS summary output name')
@click.option('--a1_header', metavar='<str>', help='index of allele 1 in GWAS summary')
@click.option('--a2_header', metavar='<str>', help='index of allele 2 in GWAS summary')
def transfer_atcg(dir, inputfile, output_file_name, a1_header_index, a2_header_index):
    gprs = GPRS()
    gprs.transfer_atcg(dir_output=dir_output, inputfile=inputfile, output_file_name=output_file_name,
                       a1_header_index=a1_header_index, a2_header_index=a2_header_index)
